...
; what base value to use when the terms run out. Write
; accumulate and show how sum and product can both be
; defined as simple calls to accumulate.
;
; b.
; If your accumulate procedure generates a recursive
...
(define (accumulate-recursive combiner null-value term a next b)
    (define (recursion i)
        (if (> i b)
            null-value
            (combiner (term i) (recursion (next i)))))
    (recursion a))
